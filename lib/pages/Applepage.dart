    ...
    final List<Map<String, String>> appleProducts = [
      {
        ...
        'name': 'Iphone 15 Pro',
        'details': 'Experience the pinnacle of innovation with the iPhone 15 Pro . Featuring a stunning Super Retina XDR display, an advanced A-series chip for unparalleled performance, and a revolutionary camera system with enhanced low-light capabilities, it redefines what a smartphone can do',
        'price': '29.99'
      },
      {
